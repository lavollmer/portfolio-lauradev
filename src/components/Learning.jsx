...
const Learning = ({ title, content }) => {
  return (
    <div className="flex flex-col rounded-lg shadow-lg bg-white dark:bg-gray-800 overflow-hidden font-jost w-full h-full w-[200px] h-[200px] md:w-[400px] md:h-[300px] lg:w-[400px] lg:h-[300px]">
