...
const ProjectsCard = ({
  ...
  return (
    <div className="flex flex-col rounded-lg shadow-lg bg-white dark:bg-gray-800 overflow-hidden sm:w-[500px] sm:h-[700px] md:w-[500px] md:h-[700px] lg:w-[400px] lg:h-[700px] m-4">
