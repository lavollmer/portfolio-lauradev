      ...
      <div className="flex flex-col items-center justify-center">
        <div className="flex flex-col lg:flex-row flex-wrap ">
          <Card
            ...
            content="I created a full-featured React and Python web project integrating a navigation bar, hero section, call-to-action, footer, and enhanced with Google Text-to-Speech AI."
            skillOne="REACTJS"
